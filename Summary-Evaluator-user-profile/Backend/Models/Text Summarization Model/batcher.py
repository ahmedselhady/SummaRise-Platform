...
class Example(object):
  ...
  def __init__(self, article, vocab, hps):
...
class Batcher(object):
  ...
  def __init__(self, articles_list, vocab, hps, single_pass):
  ...
  def fill_example_queue(self):
    ...
    input_gen = self.text_generator(self.articles_list)
    #while True:
    try:
      article = input_gen.__next__()
    ...
    example = Example(article,  self._vocab, self._hps)  # Process into an Example.
  ...
  def text_generator(self, articles_list):
    """Generates article and abstract text from tf.Example.
    Args:
    example_generator: a generator of tf.Examples from file. See data.example_generator"""
